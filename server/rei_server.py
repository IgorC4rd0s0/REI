...
def admin_html(user: dict | None, message: str = "", error: str = "") -> str:
    ...
    *{box-sizing:border-box}body{margin:0;font-family:Inter,Segoe UI,Arial,sans-serif;background:var(--bg);color:#20283b}
    ...
    button{min-height:42px;display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid transparent;border-radius:12px;padding:0 16px;font-size:13px;font-weight:800;line-height:1.2;white-space:nowrap;cursor:pointer;background:var(--navy);color:#fff;transition:filter .16s ease,transform .16s ease,box-shadow .16s ease}button:hover{filter:brightness(.96)}button:active{transform:translateY(1px)}button:focus-visible{outline:3px solid rgba(64,90,168,.28);outline-offset:2px}button:disabled{opacity:.55;cursor:not-allowed;transform:none}.full{width:100%;margin-top:18px}
...
def admin_items_html(user: dict | None, message: str = "", error: str = "") -> str:
    ...
    *{box-sizing:border-box}body{margin:0;font-family:Inter,Segoe UI,Arial,sans-serif;background:var(--bg);color:#20283b}
    ...
    textarea{min-height:74px;resize:vertical}button{min-height:42px;display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid transparent;border-radius:12px;padding:0 16px;font-size:13px;font-weight:850;line-height:1.2;white-space:nowrap;cursor:pointer;background:var(--navy);color:#fff;transition:filter .16s ease,transform .16s ease,box-shadow .16s ease}button:hover{filter:brightness(.96)}button:active{transform:translateY(1px)}button:focus-visible{outline:3px solid rgba(64,90,168,.28);outline-offset:2px}button:disabled{opacity:.55;cursor:not-allowed;transform:none}.full{width:100%;margin-top:3px}.btn.secondary,.logout{background:#fff;color:var(--navy);border-color:var(--line)}.btn.danger{background:#fde9e6;color:#a52b22;border-color:#f3c9c4}.item-switch button{min-height:0}.mini-delete,.field-edit summary{min-height:0}
    ...
    .modal{position:fixed;inset:0;background:rgba(12,19,40,.48);display:grid;place-items:center;z-index:20;padding:18px}.modal .card{width:min(540px,100%);max-height:88vh;overflow:auto}.admin-modal .card{width:min(520px,100%)}.admin-settings-card .row{display:flex;align-items:center;gap:12px}.admin-settings-card h2{margin:0 0 4px;font-size:18px}.admin-settings-card h3{margin:0 0 4px;font-size:15px}.theme-settings{margin:18px 0;padding:14px;border:1px solid var(--line);border-radius:15px;background:var(--soft)}.theme-settings .muted{margin:0 0 10px}.theme-options{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.theme-option{width:100%;background:#fff;color:var(--navy);border-color:var(--line)}.theme-option.active{background:var(--navy);color:#fff;border-color:var(--navy)}.admin-password-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.password-actions{display:flex;justify-content:flex-end;margin-top:14px}.admin-settings-actions{display:flex;align-items:center;justify-content:flex-end;gap:10px;margin-top:20px;padding-top:16px;border-top:1px solid var(--line)}.admin-settings-actions form{margin:0}
